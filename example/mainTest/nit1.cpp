...
DWORD WINAPI nit1run(){
	...
	wait(mutex); cout<<"Nit1: Najavljeno koriscenje fajla '"<<decFPath<<"'"<<endl; signal(mutex);
	...
	//char decFPath[]="1:\\fajl3.dat";
	decFPath[0]=p1;decFPath[7]='3';
	FS::declare(decFPath,1);
	wait(mutex); cout<<"Nit1: Najavljeno koriscenje fajla '"<<decFPath<<"'"<<endl; signal(mutex);
	
	//char decFPath[]="2:\\fajl4.dat";
	...
	//2.blok
	{
		...
		wait(mutex); cout<<"Nit1: Otvoren fajl 'fajl3.dat'"<<endl; signal(mutex);
		char filepath2[]="2:\\fajl4.dat";
		filepath2[0]=p2;
		dst=FS::open(filepath2);
		wait(mutex); cout<<"Nit1: Otvoren fajl 'fajl4.dat'"<<endl; signal(mutex);
	...
	wait(mutex); cout<<"Nit1: Odjavljeno koriscenje fajla '"<<decFPath<<"'"<<endl; signal(mutex);
